	...
	:VSAnimTree(ShowName)
{
	...
	VSAnimSequenceFunc* pAnimSequenceAttack = MEM_NEW VSAnimSequenceFunc(_T("Attack"), this);
	pAnimSequenceAttack->SetAnim(_T("Attack2"));
	VSAnimSequenceFunc* pAnimSequenceIdle = MEM_NEW VSAnimSequenceFunc(_T("Idle"), this);
	pAnimSequenceIdle->SetAnim(_T("Idle"));
	VSOneParamImmediateAnimBlend * pIdle_Attack = MEM_NEW VSOneParamImmediateAnimBlend(_T("Idle_Attack"), this);
	...
	VSAnimSequenceFunc* pAnimSequenceWalk = MEM_NEW VSAnimSequenceFunc(_T("Walk"), this);
	pAnimSequenceWalk->SetAnim(_T("Walk"));

	VSPartialAnimBlend * pWalk_Attack= MEM_NEW VSPartialAnimBlend(_T("Walk_Attack"), this);
	...
	VSOneParamImmediateAnimBlend * pFinal = MEM_NEW VSOneParamImmediateAnimBlend(_T("Final"), this);
	pFinal->AddInputNode();
...
:VSAnimTree(ShowName)
{
	...
	VSOneParamImmediateAnimBlend * pIdle_Walk = MEM_NEW VSOneParamImmediateAnimBlend(_T("Idle_Walk"), this);
	...
	VSPartialAnimBlend * pBlend_Attack = MEM_NEW VSPartialAnimBlend(_T("Blend_Attack"), this);

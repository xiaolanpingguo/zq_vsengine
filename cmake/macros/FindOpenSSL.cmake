...
IF(WIN32 AND NOT CYGWIN)
  ...
  IF(MSVC)
	...
	FIND_LIBRARY(CRYTO_DEBUG
      NAMES
       libcrypto${_OPENSSL_MSVC_ARCH_SUFFIX}MDd
      PATHS
        ${OPENSSL_ROOT_DIR}/lib/VC
    )

    FIND_LIBRARY(CRYTO_RELEASE
      NAMES
       libcrypto${_OPENSSL_MSVC_ARCH_SUFFIX}MD
      PATHS
        ${OPENSSL_ROOT_DIR}/lib/VC
    )
    ...
    if( CMAKE_CONFIGURATION_TYPES OR CMAKE_BUILD_TYPE )
      set( OPENSSL_LIBRARIES
        optimized ${SSL_EAY_RELEASE} ${LIB_EAY_RELEASE} ${CRYTO_RELEASE}
        debug ${SSL_EAY_DEBUG} ${LIB_EAY_DEBUG} ${CRYTO_DEBUG}
      )
    else()
      set( OPENSSL_LIBRARIES
        ${SSL_EAY_RELEASE}

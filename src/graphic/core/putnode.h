...
class VSOutputNode;
class VSStream;
class GRAPHIC_API VSPutNode : public VSObject
{
	//RTTI
	DECLARE_RTTI;
...
protected:
	VSPutNode(uint32 uiValueType,const VSUsedName & NodeName,VSObject * pShaderFunction);
	VSPutNode();
	VSObject * m_pOwner;
...
public:
	...
	inline void SetValueType(uint32 uiValueType)
	{
...
class GRAPHIC_API VSInputNode : public VSPutNode
{
	//RTTI
	DECLARE_RTTI;
	DECLARE_INITIAL
...
public:
	VSInputNode(uint32 uiValueType,const VSUsedName &NodeName,VSObject * pObject);
	virtual ~VSInputNode();
protected:
	VSInputNode();
...
class GRAPHIC_API VSOutputNode:public VSPutNode
{
	//RTTI
	DECLARE_RTTI;
	DECLARE_INITIAL
...
public:
	...
	VSOutputNode(uint32 uiValueType,const VSUsedName &NodeName,VSObject * pShaderFunction);
...
public:
	...
	VSInputNode * GetInputLink(uint32 i)
	{

...
VSTextureUnorderAccess::VSTextureUnorderAccess(uint32 uiWidth, uint32 uiHeight,
...
VSTextureUnorderAccess::VSTextureUnorderAccess(VS2DTexture * pCreateBy,uint32 uiLevel, bool CPURead)
{
...
VSTextureUnorderAccess::VSTextureUnorderAccess(VS2DTextureArray * pCreateBy,uint32 uiLevel,
...
VSTextureUnorderAccess::VSTextureUnorderAccess(VS3DTexture * pCreateBy, uint32 uiLevel,
	uint32 First, uint32 uiArraySize, bool CPURead)
{
	m_uiFirst = First;
	m_uiFormatType = pCreateBy->GetFormatType();

...
{
	class VSStream;
	class GRAPHIC_API VSBlendDesc : public VSObject
	{
		DECLARE_RTTI;
		DECLARE_INITIAL
	public:
		...
		VSBlendDesc()
		{
			...
			for (uint32 i = 0 ; i < MAX_RENDER_TARGET_NUM ;i++)
			{
...
// 		unsigned int	ucSampleMask;
		...
		bool IsBlendUsed(uint32 uiChannal = 0)const
		{
	...
	class GRAPHIC_API VSBlendState : public VSBind
	{
		//PRIORITY

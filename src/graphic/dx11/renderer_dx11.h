...
class VSQueryID;
class GRAPHIC_API VSDX11Renderer : public VSRenderer
{
public:
...
protected:
	...
	static float ms_fHSMaxTessFactor;
...
protected:
	...
	void DrawDynamicScreenData(void * pScreenBuffer, unsigned int uiVertexNum, unsigned int uiVertexStride, uint16 * pIndexBuffer, unsigned int uiIndexNum);

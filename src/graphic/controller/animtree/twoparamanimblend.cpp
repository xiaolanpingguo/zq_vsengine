...
void VSTwoParamAnimBlend::CreateSlot(uint32 uiWidth, uint32 uiHeight)
{
	m_pInput.Clear();
	m_uiWidth = uiWidth;
	m_uiHeight = uiHeight;
...
VSAnimFunction * VSTwoParamAnimBlend::GetAnimFunction(uint32 i, uint32 j)
{

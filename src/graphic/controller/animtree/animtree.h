...
namespace zq
{
	...
	class VSStream;
	class VSAnimAtom;
	class GRAPHIC_API VSAnimTree : public VSController , public VSResource
	{
		//RTTI
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	class GRAPHIC_API VSAnimTreeOneAnim : public VSAnimTree
	{
	public:
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	class GRAPHIC_API VSAnimTreeTwoSmoothBlendAnim : public VSAnimTree
	{
	public:
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	class GRAPHIC_API VSAnimTreeTwoImmediateAnim : public VSAnimTree
	{
	public:
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	class GRAPHIC_API VSAnimTreePartialAnim : public VSAnimTree
	{
	public:
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	class GRAPHIC_API VSAnimTreeRectBlendAnim : public VSAnimTree
	{
	public:
		DECLARE_RTTI;
		DECLARE_INITIAL

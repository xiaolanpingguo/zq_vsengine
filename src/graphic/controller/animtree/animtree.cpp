...
#include "graphic/controller/animtree/oneparamImmediateanimblend.h"
...
VSAnimTree::VSAnimTree(const VSUsedName &ShowName)
{
	...
	m_pAnimMainFunction = MEM_NEW VSAnimMainFunction(_T("AnimTree"),this);
...
:VSAnimTree(ShowName)
{
	VSAnimSequenceFunc* pAnimSequenceFunc = MEM_NEW VSAnimSequenceFunc(_T("Squence"),this);
...
:VSAnimTree(ShowName)
{
	VSOneParamSmoothAnimBlendSequence* pAnimBlend = MEM_NEW VSOneParamSmoothAnimBlendSequence(_T("OneParamSmoothAnimBlendSequence"), this);
...
:VSAnimTree(ShowName)
{
	VSAnimSequenceFunc* pAnimSequenceFunc1 = MEM_NEW VSAnimSequenceFunc(_T("Squence1"), this);

	pAnimSequenceFunc1->SetAnim(AnimName1);

	VSAnimSequenceFunc* pAnimSequenceFunc2 = MEM_NEW VSAnimSequenceFunc(_T("Squence2"), this);

	pAnimSequenceFunc2->SetAnim(AnimName2);

	VSOneParamImmediateAnimBlend * pAnimBlend = MEM_NEW VSOneParamImmediateAnimBlend(_T("OneParamBlend"), this);
...
:VSAnimTree(ShowName)
{
	...
	VSPartialAnimBlend * pAnimBlend = MEM_NEW VSPartialAnimBlend(_T("PartialAnimBlend"), this);
...
:VSAnimTree(ShowName)
{
	...
	VSAnimSequenceFunc* pAnimSequenceFunc3 = MEM_NEW VSAnimSequenceFunc(_T("Squence3"),this);

	pAnimSequenceFunc1->SetAnim(AnimName3);

	VSAnimSequenceFunc* pAnimSequenceFunc4 = MEM_NEW VSAnimSequenceFunc(_T("Squence4"),this);

	pAnimSequenceFunc2->SetAnim(AnimName4);


	VSRectAnimBlend * pAnimBlend = MEM_NEW VSRectAnimBlend(_T("RectBlend"),this);

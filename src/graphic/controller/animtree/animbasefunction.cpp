...
VSInputNode * VSAnimBaseFunction::GetInputNode(uint32 uiNodeID)const
{
...
VSOutputNode * VSAnimBaseFunction::GetOutputNode(uint32 uiNodeID)const
{
...
void VSAnimBaseFunction::GetAnimDataInstance(VSAnimBaseFunction * pSource, VSAnimBaseFunction * pTarget, float fWeight)
{
	for (uint32 i = 0 ; i < pSource->m_AnimDataInstance.GetNum() ; i++)
	{

...
namespace zq
{
	...
	*/
	class VSStream;
	class GRAPHIC_API VSOneParamImmediateAnimBlend : public VSOneParamAnimBlend
	{
		//RTTI
		DECLARE_RTTI;
		DECLARE_INITIAL
	...
	protected:
		VSArray<float> m_NodeCrossFadingTime;
		float			m_fCrossFadingTime;
		unsigned int	m_uiLastAnimIndex;
		unsigned int	m_uiCurAnimIndex;
	public:
		inline void SetNodeCrossFadingTime(uint32 uiIndex, float fTime)
		{

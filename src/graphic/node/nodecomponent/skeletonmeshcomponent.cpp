...
bool VSSkeletonMeshComponent::BeforeSaveWithUserData(void * pData)
{
	return true;
}
...
bool VSSkeletonMeshComponent::PlayAnim(const VSString & AnimName, float fRatio, uint32 uiRepeatType)
{
	VSMeshNode * pMeshNode = m_pNode;
	if (pMeshNode)
	{

...
void VSModelMeshNode::SetUseMaterialInstance(uint32 SubMeshID,uint32 UsedID)
{
...
VSGeometryNode * VSModelMeshNode::GetGeometryNode(uint32 uiLodLevel)
{
...
bool VSModelMeshNode::AddLODGeometryNode(VSGeometryNode* pGeoNode)
{
	...
	if (!LodNode)
	{
		...
		LodNode = MEM_NEW VSModelSwitchNode();

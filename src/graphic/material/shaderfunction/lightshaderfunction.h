...
{
	class VSStream;
	class GRAPHIC_API VSLightColor : public VSShaderFunction
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	class GRAPHIC_API VSLightSpecular : public VSShaderFunction
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	class GRAPHIC_API VSLightDir : public VSShaderFunction
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	class GRAPHIC_API VSLightShaderFunction : public VSShaderFunction
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY

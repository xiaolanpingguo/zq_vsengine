...
#include "graphic/pass/shadowpass.h"
...
{
	class VSStream;
	class GRAPHIC_API MaterialCustomPara : public VSObject
	{
	public:
		DECLARE_RTTI;
		...
		GRAPHIC_API friend bool operator >(const MaterialCustomPara &Para1,const MaterialCustomPara &Para2)
		{
	...
	class GRAPHIC_API CustomFloatValue : public MaterialCustomPara
	{
	public:
		DECLARE_RTTI;
		//PRIORITY
	...
	class GRAPHIC_API VSCustomMaterialInterface : public VSObject
	{
		//RTTI
		DECLARE_RTTI;
		DECLARE_INITIAL_NO_CLASS_FACTORY;
	...
	class GRAPHIC_API VSCustomCSMaterial : public VSCustomMaterialInterface
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	public:
		...
		bool UseMaterial(uint32 uiThreadGroupCountX, uint32 uiThreadGroupCountY, uint32 uiThreadGroupCountZ);
	...
	class GRAPHIC_API VSCustomMaterial : public VSCustomMaterialInterface
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	public:
		VSCustomMaterial(const VSUsedName & ResourceName,
						...
						const char * pGShaderFileName = NULL, const char * pGMainFunName = NULL,
						const char * pHShaderFileName = NULL, const char * pHMainFunName = NULL,
						const char * pDShaderFileName = NULL, const char * pDMainFunName = NULL);
	...
	class GRAPHIC_API VSMaterial : public VSObject, public VSResource
	{
		//RTTI
		DECLARE_RTTI;
		//PRIORITY
	...
	protected:
		...
		uint32 m_uiTessellationPartitioning;
	...
	public:
		...
		void SetTessellationPartitioning(uint32 uiTessellationPartitioning);
		inline uint32 GetTessellationPartitioning() const { return m_uiTessellationPartitioning; }
		void SetBlendState(VSBlendState * pBlendState,uint32 uiPassId = 0);
		void SetDepthStencilState(VSDepthStencilState *pDepthStencilState,uint32 uiPassId = 0);
		void SetRasterizerState(VSRasterizerState *pRasterizerState,uint32 uiPassId = 0);
		void AddClipPlane(const Plane & Plane,uint32 uiPassId = 0);
		void AddScissorRect(const VSRect2 & Rect,uint32 uiPassId = 0);
		void AddPass(uint32 uiMUT);
		inline VSRenderState & GetRenderState(uint32 uiPassId)
		{
		...
		VSMaterial(const VSUsedName &ShowName, uint32 uiMUT = MUT_PHONE);
		virtual ~VSMaterial();
		...
		uint32 GetShaderMainFunctionNum()const
		{
	...
	public:
		...
		uint32 m_uiCustomLayer;
		void GetInstanceVertexFormat(VSArray<VSVertexFormat::VERTEXFORMAT_TYPE>& FormatArray, uint32 &uiOffset);
		int32 GetInstanceIndex(const class VSConstFloatValue * pCFValue);
	};
	DECLARE_Ptr(VSMaterial);
	DECLARE_Proxy(VSMaterial);
	VSTYPE_MARCO(VSMaterial);

	class GRAPHIC_API VSMaterialInstance: public VSObject
	{
		//RTTI
		DECLARE_RTTI;
	...
	public:
		...
		void SetShaderValue(const VSUsedName & Name,void *fValue,uint32 uiSize);
		...
		void GetInstanceData(unsigned char* pInstanceDataBuffer, uint32 &GetSize);
	...
	class GRAPHIC_API VSMaterialOnlyTexture : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialTextureAndNormal : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialInstanceTest : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialOnlyEmissive : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialNoLight : public VSMaterial
	{
	protected:
		VSMaterialNoLight();
	public:
	...
	class GRAPHIC_API VSMaterialOrenNayar : public VSMaterial
	{
	protected:
		VSMaterialOrenNayar();
	public:
	...
	class GRAPHIC_API VSMaterialPhone : public VSMaterial
	{
	protected:
		VSMaterialPhone();
	public:
	...
	class GRAPHIC_API VSMaterialPhoneTwoPass : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialCustom : public VSMaterial
	{
	protected:
		VSMaterialCustom();
	public:
	...
	class GRAPHIC_API VSLightMaterial : public VSMaterial
	{
	protected:
		VSLightMaterial();
	public:
	...
	class GRAPHIC_API VSPostEffectMaterial : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialPhoneWolrdOffset : public VSMaterial
	{
	protected:
	...
	class GRAPHIC_API VSMaterialTessellation : public VSMaterial
	{
	protected:
